...
# ------------------------------------------------------
pdf_path = "a01-014u.pdf"  # input PDF of handwritten answer script
gt_path = "a01-014u.docx"  # ground truth DOCX file
...
print("✅ Full report saved to ocr_comparison_report_trocr.txt")